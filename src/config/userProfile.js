...
export const githubRepos = [
  ...
  {
    name: 'esp32-edge-inference',
    desc: '基于 ESP32-S3 的轻量级边缘推理框架，支持 TensorFlow Lite Micro 模型部署，含手势识别与关键词检测示例。',
    lang: 'C++',
    langColor: '#f34b7d',
    stars: 63,
    forks: 18,
...
export const projectGridItems = [
  {
    title: 'STM32',
    desc: '面向 STM32F108C8T6 系列的高复用 HAL 外设驱动模板库，涵盖 I2C、SPI、UART、ADC 等常用外设，附带 CMSIS-RTOS 适配示例。',
    tags: ['嵌入式'],
    stars: 47,
  },
  {
    title: 'ESP32-S3 边缘推理引擎',
    desc: '轻量级 TinyML 运行时，支持 DeepSeek V4-flash/Pro 模型加载与硬件加速推理。',
    tags: ['嵌入式', 'AI'],
    stars: 63,
  },
  {
    title: 'IoT 环境监测方案',
    desc: '端到端物联网环境监测——传感器节点 + LoRa 无线组网 + MQTT 数据上云 + Web 可视化面板。',
    tags: ['IoT', '嵌入式'],
    stars: 35,
  },
  {
    title: 'MQTT-BLE 协议桥接器',
    desc: '跨协议智能网关，自动发现 BLE 设备并桥接至 MQTT 网络，适用于智能家居与工业传感。',
    tags: ['IoT'],
    stars: 28,
  },
  {
    title: '个人技术网站',
    desc: '基于 Vue 3 + Vite + Tailwind CSS 构建的响应式个人技术作品集展示网站。',
    tags: ['Web'],
    stars: 15,
  },
  {
    title: '嵌入式开发工具箱',
    desc: '串口调试助手、I2C 扫描器、传感器数据可视化，一站式嵌入式桌面工具链。',
    tags: ['Web', '嵌入式'],
    stars: 41,
  },
]
